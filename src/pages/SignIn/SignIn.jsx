...
export default function Sign() {
    ...
    // direct the user to home page --> useEffect
    React.useEffect( () => {
          ...
          <form>
            ...
            <div className="form-floating Password">
              ...
              <span className="ShowPassword">
                <i onClick={ () => setIsVisible( !isVisible ) } className="far fa-eye"></i>
              </span>
              <label htmlFor="floatingPassword">Password</label>
            </div>
  
            <button onClick={ onSignInHandler } className="w-100 btn btn-lg btn-primary" type="button">
              Sign in
            </button>
